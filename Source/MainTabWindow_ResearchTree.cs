    ...
    public class MainTabWindow_ResearchTree : MainTabWindow
    {
        ...
        public override void PreOpen()
        {
            ...
            if ( !ResearchTree.Initialized )
            {
                ...
                // check if using tree makes any kind of sense
                _useTree = ResearchTree.Trees.Count > 2 && ResearchTree.Trees.Select( tree => tree.MaxDepth ).Max() > 3;
            }

            // debug, alternate use tree.
            _useTree = !_useTree;
            ...
            {
                currentWindowRect.width = Math.Min( 800, Screen.width );
                currentWindowRect.height = Math.Min( 600, Screen.width - 35 );
                currentWindowRect.x = (Screen.width - currentWindowRect.width) / 2;
                currentWindowRect.y = ( Screen.height - currentWindowRect.height ) / 2;
        ...
        public void DrawList( Rect inRect )
        {
